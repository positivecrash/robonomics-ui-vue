...
<style>
  ...
  :root {
    ...
    --robo-button-gap: calc(var(--robo-input-padding) * 1.5);
...
.robo-button-size-tiny {
  --robo-button-fontsize: calc(var(--robo-input-fontsize) * 0.6);
  --robo-button-padding: calc(var(--robo-input-padding) * 0.4);
  --robo-button-gap: calc(var(--robo-input-padding) * 0.4);
}
...
.robo-button-size-small {
  ...
  --robo-button-gap: calc(var(--robo-input-padding) * 0.6);
}
...
.robo-button-size-large {
  ...
  --robo-button-gap: calc(var(--robo-input-padding)*2);
}
