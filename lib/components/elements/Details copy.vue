...
onMounted(() => {
  ...
  document.body.addEventListener('click', (e) => {
    document
      .querySelectorAll('.robo-details--closeOutOfFocus[tabindex="0"]')
      .forEach(detailsEl => {
        // если кликнутый элемент находится внутри этого details — не закрываем
...
<style>
  ...
  /* @media (prefers-color-scheme: dark){
    ...
    .robo-details .robo-text--linemiddle {
      --background: var(--robo-details-tooltip-background) !important;
      --color: var(--robo-details-tooltip-color) !important;
    }
  } */
  ...
  /* .robo-details .robo-text--linemiddle {
    --background: var(--robo-details-popup-background) !important;
    --color: var(--robo-details-popup-color) !important;
  } */
</style>
...
<style scoped>
  ...
  .robo-details--inital .robo-details-content-inside {
    padding-left: 0;
    padding-right: 0;
  }
  /* - content */
